...
export const Spots = () => {
    ...
    <div class="card-group sf-icon-cards" style={{"margin-top": "2rem", "margin-bottom": "2rem"}}>
        <div class="card">
            ...
            <div class="card-body">
            <h5 class="card-title text-center">Purchasing in our Fundraising</h5>
    ...
    <p class="text-center" style={{"font-weight": "300", "font-size": "150%"}}>YOUR INCOME BY PURCHASING AND RENTING</p>

     <div class="card-group sf-icon-cards" style={{"margin-top": "2rem", "margin-bottom": "2rem"}}>
         <div class="card">
             <div class="card-body">
             <h5 class="card-title text-center">In 1 Year max</h5>
             <span style={{"font-size": "1.7rem"}}>$504.00</span>
             </div>
         </div>
         <div class="card">
             <div class="card-body">
             <h5 class="card-title text-center">In 3 Years max</h5>
             <span style={{"font-size": "1.7rem"}}>$1,512.00<br/></span>
             </div>
         </div>
         <div class="card">
             <div class="card-body">
             <h5 class="card-title text-center">In 5 Years max</h5>
     ...
     <p>Book a meeting with us to get to know you and show you a demo and learn more.</p>
