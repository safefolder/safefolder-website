    ...
    <div class="card-group" style={{"margin-top": "2rem", "margin-bottom": "2rem"}}>
        <div class="card">
            ...
            <div class="card-footer" style={{"text-align": "center"}}>
                <small class="text-body-secondary"><b>FREE</b></small>
            </div>
        </div>
        <div class="card">
            <div class="card-body">
            ...
            <div class="card-footer" style={{"text-align": "center"}}>
                <small class="text-body-secondary"><b>$9 / Month</b></small>
            </div>
        </div>
        <div class="card">
            <div class="card-body">
            ...
            <div class="card-footer" style={{"text-align": "center"}}>
                <small class="text-body-secondary"><b>$20 / Month</b></small>
            </div>
        </div>
        <div class="card">
            <div class="card-body">
            ...
            <div class="card-footer" style={{"text-align": "center"}}>
                <small class="text-body-secondary"><b>$40 / Month</b></small>
            </div>
        </div>        
    </div>
