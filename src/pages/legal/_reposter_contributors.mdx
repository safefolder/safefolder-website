---
title: Reposter Contributor Agreement
path: /legal/reposter-contributors/
date: 2025-03-03
description: Reposter contributor agreement for Safefolder collaborator economy
titleColor: white
...
tags:
    ...
    - Legal
share:
    url: https://safefolder.app/legal/reposter-contributors/
    title: Safefolder Reposter Contributor Agreement
    hashtag: safefolder
    summary: Check out Safefolder reposter contributor agreement for our collaboration economy
    source: Safefolder reposter contributor agreement
    hashtags:
        - safefolder
    subject: Safefolder reposter contribution agreement for our collaboration economy
    body: Check out Safefolder reposter contributor agreement for our collaboration economy
author: Jorge Alegre
---

<div class="btn-group mt-5 mb-5 container-fluid">
  <a href="/legal/product-contributors/" class="btn btn-primary" >Product</a>
  <a href="/legal/reposter-contributors/" class="btn btn-primary active" aria-current="page">Reposters</a>
</div>
...
assist in the distribution and repost of Owner social media content, and Contributor 
is willing to provide the distribution services (the "Services") subject to the terms and 
conditions set forth herein, working as contributor in Safefolder promotions.
...
1. **EFFECTIVE DATE**
    ...
    This Agreement shall be effective when contributor starts onborading as reposter after
    having been approved by Owner.

2. **DEFINITIONS**

    a) "Social content" shall mean the posts from Safefolder social accounts published
    by Owner.

    b) “Owner” means third party companies the Contributor develops software for. These
...
3. **COMPENSATION**
    ...
    to contribute to Safefolder without an economic compensation.

    b) Safefolder provides a reward for Contributor for helping in the distribution in a
    free way with an exchange of Spots, a digital property minted as Non Fungible Tokens (NFTs).
    These spots represent an appreciation or reward for helping in the distribution of Safefolder
    products.

    c) Contributor needs to repost a minimum of social content from Owner to keep being in the program
    and earn the reward in credits and NFT certificates. The rewards are defined in the Owner web site.
